...
function geneticAlgorithm(initialChildren, generations, goal, length) {
  ...
  for (let generationCount=0; generationCount<=generations; generationCount++) {
...
geneticAlgorithm(children, generations, goal, length);
